...
| [arena_concurrent](arena_concurrent.md) | Wait-free bump (`atomicrmw add`) from many threads | concurrent |
| [pool](pool.md) | Fixed-size blocks, O(1) alloc/free, individual lifetimes | single-threaded |
| [pool_concurrent](pool_concurrent.md) | Lock-free Treiber free list + wait-free bump; tagged 64-bit CAS | concurrent |
